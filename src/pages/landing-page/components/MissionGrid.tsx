...
export function MissionGrid({ onBack, onSelectMission, missions }: MissionGridProps) {
  ...
  const availableMissions: LandingMission[] =
    missions && missions.length > 0
      ? missions
          ...
          .map((title) => getMissionByTitle(title)!)
      : MISSIONS
      ...
      <div className='relative z-10 px-6 md:px-12 py-6'>
        ...
        >
          ...
          <p className='text-gray-400 max-w-2xl mx-auto'>
            Each mission presents a unique clinical scenario. Select one to begin your
            evidence-based nursing investigation.
          </p>
        </motion.div>
