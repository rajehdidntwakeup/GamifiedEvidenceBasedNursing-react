      ...
      >
        ...
        <form onSubmit={handleAuthSubmit}>
          <div className='space-y-4 mb-6'>
            <div>
              <label htmlFor='auth-username' className='block text-sm text-gray-400 mb-2'>
                Username
              </label>
              <input
                id='auth-username'
            ...
            <div>
              <label htmlFor='auth-password' className='block text-sm text-gray-400 mb-2'>
                Password
              </label>
              <input
                id='auth-password'
            ...
            {mode === 'register' && (
              <div>
                <label htmlFor='auth-confirm-password' className='block text-sm text-gray-400 mb-2'>
                  Confirm Password
                </label>
                <input
