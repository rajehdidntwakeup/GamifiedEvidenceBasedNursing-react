        ...
        <div className='flex items-center justify-center px-4 py-12 print:py-0 print:px-0'>
          ...
          >
            ...
            <div className='relative z-10 flex flex-col items-center justify-center h-full px-12 py-10'>
              ...
              >
                for successfully completing all four rooms of the EBNA Escape Room, demonstrating
                exceptional skill in evidence-based nursing practice, critical appraisal of
                research, and scientific reasoning — and for solving the case by identifying{' '}
              ...
              <p className='text-[#0f4c5c]/30 italic text-center mt-6' style={{ fontSize: '10px' }}>
                &ldquo;The very first requirement in a hospital is that it should do the sick no
                harm.&rdquo; — Florence Nightingale
              </p>
            </div>
          ...
          >
            ...
            >
              <div className='inline-flex items-center gap-2 px-4 py-2 rounded-full bg-teal-500/10 border border-teal-500/30 text-teal-300 mb-6'>
                ...
                <span className='font-[JetBrains_Mono,monospace] text-sm'>CASE SOLVED</span>
              </div>
              ...
              <p className='text-gray-400 text-lg max-w-xl mx-auto mb-8'>
                The founder of modern nursing and a pioneer of evidence-based practice. She used
                statistical analysis to revolutionize healthcare — proving that evidence saves
                lives.
              </p>
            </motion.div>
            ...
            >
              <p className='text-gray-300 text-sm italic mb-3' style={{ lineHeight: 1.8 }}>
                &ldquo;The very first requirement in a hospital is that it should do the sick no
                harm.&rdquo;
              </p>
            ...
            >
              <div className='bg-gradient-to-br from-yellow-500/10 to-orange-500/10 border border-yellow-500/30 rounded-2xl p-6 max-w-md mx-auto'>
                ...
                <p className='text-gray-400 text-sm mb-5'>
                  You&apos;ve earned the prestigious Expert of Evidence certificate. Enter your team
                  name to claim it!
                </p>
                <button
        ...
        {showTeamPrompt && (
          <div className='fixed inset-0 z-[60] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4'>
            ...
            >
              ...
              <p className='text-gray-400 text-sm mb-5'>
                Enter your team name to generate your personalized Expert of Evidence certificate.
              </p>
          ...
          <div className='max-w-2xl w-full'>
            ...
            >
              ...
              <p className='text-gray-400 max-w-lg mx-auto'>
                You&apos;ve collected 8 letters from all four rooms. Arrange them to reveal the name
                that inspired evidence-based nursing.
              </p>
            </motion.div>
            ...
            >
              {[
                ...
                >
                  <span className='text-gray-500 text-xs block mb-1'>Room {r.room}</span>
                ...
                {shuffledLetters.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className='text-[9px] text-gray-600 mt-0.5'>R{item.room}</span>
                    </motion.button>
                  )
                })}
              </div>
